...
import { generateTokens, tokenize } from "./tokenizer.js";
...
describe("tokenize", () => {
  ...
  it("should tokenize crawl-delay statements", () => {
    expect(tokenize("crawl-delay: 10")).toEqual(
      expect.arrayContaining([
        {
          type: "CRAWL_DELAY",
          value: "crawl-delay",
  ...
  it("should tokenize sitemap statements", () => {
    expect(tokenize(`sitemap: https://www.example.com/sitemap.xml`)).toEqual(
      expect.arrayContaining([
        {
          type: "SITEMAP",
          value: "sitemap",
